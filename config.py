...
APP_ID = int(os.environ.get("APP_ID", "26617321")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "40daa567bfe70fb71d9727c4a93b6503") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002506943014")) #Your db channel Id
OWNER = os.environ.get("OWNER", "bdflix_admin") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "5488475852")) # Owner id
#--------------------------------------------
